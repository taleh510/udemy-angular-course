...
ob_start();
session_start();
include 'nadmin/netting/connect.php';
...
$slider0 = $db->prepare("SELECT * FROM slider where slider_id=:id");
$slider0->execute(array('id' => 0));
$slidercek0 = $slider0->fetch(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html lang="en">
