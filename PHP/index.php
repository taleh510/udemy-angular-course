	...
	<div id="sync1" class="owl-carousel">
		<div class="item">
			<div class="slide-desc">
				<div class="inner">
					<h1><?php echo $slidercek0['slider_title'] ?></h1>
					<p>
						<?php echo $slidercek0['slider_description'] ?>
					</p>
				...
				<div class="inner">
					<div class="pro-pricetag big-deal">
						<div class="inner">
							<span class="oldprice"><?php echo $slidercek0['slider_cost'] ?></span>
							<span><?php echo $slidercek0['slider_costpercent'] ?></span>
							<span class="ondeal"><?php echo $slidercek0['slider_costtext'] ?></span>
						</div>
					</div>
				</div>
			</div>
...
<div id="sync2" class="owl-carousel">
	<div class="item">
		<div class="slide-type-1-sync">
			<h3><?php echo $slidercek0['slider_itembrand'] ?></h3>
			<p><?php echo $slidercek0['slider_itemdes'] ?></p>
		</div>
	</div>
	<div class="item">
		<div class="slide-type-1-sync">
